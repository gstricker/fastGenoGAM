...
- Warning in the size factor function: .normalize in the function DESeq2::DESeqDataSetFromMatrix. Warning most likely due to coliding methods for "Ontology" in BiocGenerics and AnnotationDbi. Solution should come from DESeq side.
