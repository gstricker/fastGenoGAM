...
```{r plot, fig.cap = "The fit of input (upper) and IP (lower) for chrI:45000-55000", fig.width = 10, fig.height = 10}
par(mfrow = c(2,1))
plot(fits(result)$chrI[,"s(x)"][idx], type = "l", main = "Input", ylab = "log-fit")
lines(upper_input, lty = 2)
lines(lower_input, lty = 2)

plot(fits(result)$chrI[,"s(x):genotype"][idx], type = "l", main = "IP", ylab = "log-fit")
